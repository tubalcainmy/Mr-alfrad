...
(function () {
  ...
  function renderCard(listing) {
    ...
    var photoHtml = photoSrc
      ? '<img src="' + escHtml(photoSrc) + '" alt="' + escHtml(listing.address) + '" loading="lazy" />'
      : "";
    ...
    var listedDate = listing.listedDate ? formatDate(listing.listedDate) : "";
    ...
    return (
      '<div class="property-card">' +
        ...
        '<div class="property-card-body">' +
          ...
          "</div>" +
          '<p class="prop-desc">' + escHtml(listing.description || "") + "</p>" +
          '<button class="btn-submit book-tour-btn" data-listing-id="' + escHtml(listing.id || "") + '" data-address="' + escHtml(listing.address || "") + '">Book a Tour</button>' +
        "</div>" +
      "</div>"
    );
  }
